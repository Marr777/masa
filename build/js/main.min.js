...
var _initMainMenu = require("./modules/main-menu/init-main-menu");
var _initSwiper = require("./modules/swiper/init-swiper");
var _customSelect = require("./modules/select/custom-select");
var _news = require("./modules/news/news");
var _setMap = require("./modules/map/set-map");
var _initTitleBreak = require("./modules/about-features/init-title-break");
var _inputFocus = require("./modules/modals/inputFocus");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _inputFocus.initFocus)();
    (0, _initAccordion.initAccordions)();
    (0, _initMainMenu.initMainMenu)();
    (0, _initSwiper.initSwiper)();
    (0, _news.initNews)();
    (0, _initTitleBreak.initTitleBreak)();
    (0, _setMap.setMap)();
...
},{"./modules/about-features/init-title-break":2,"./modules/accordions/init-accordion":4,"./modules/form-validate/form":6,"./modules/main-menu/init-main-menu":12,"./modules/map/set-map":13,"./modules/modals/init-modals":14,"./modules/modals/inputFocus":15,"./modules/news/news":17,"./modules/select/custom-select":19,"./modules/swiper/init-swiper":21,"./utils/ios-vh-fix":24}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initTitleBreak = void 0;
var titles = document.querySelectorAll('[data-name="feature-title"]');
var breakpoint = window.matchMedia('(max-width: 767px)');
var breakpointChecker = function breakpointChecker() {
  titles.forEach(function (title) {
    var lineBreak = title.querySelector('br');
...
var initTitleBreak = function initTitleBreak() {
  if (titles) {
    breakpointChecker();
    window.addEventListener('resize', breakpointChecker);
  }
};
exports.initTitleBreak = initTitleBreak;
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function openAccordion(element) {
      ...
      var wrapper = element.querySelector('[data-accordion="wrapper"]');
      var item = element.querySelector('[data-accordion="item"]');
      var btn = element.querySelector('[data-accordion="button"]');
      var buttons = element.querySelectorAll('[data-accordion="button"]');
...
var _accordions = require("../accordions/accordions");
var body = document.body;
var header = document.querySelector('[data-header="header"]');
var headerList = header.querySelector('[data-header="header-list"]');
var headerInner = header.querySelector('[data-header="header-inner"]');
var burgerBtn = header.querySelector('[data-header="header-btn"]');
var burgerIcon = burgerBtn.querySelector('.header__burger-icon');
var headerContent = header.querySelector('[data-header="header-content"]');
var dropDownBtns = document.querySelectorAll('[data-header="dropdown-button"]');
var navLinks = header.querySelectorAll('[data-header="header-link"]');
var navItems = header.querySelectorAll('[data-header="dropdown-item"]');
var dropdownLinks = header.querySelectorAll('[data-header="header-link-secondary"]');
...
var onBurgerBtnClick = function onBurgerBtnClick() {
...
var initDropdownClick = function initDropdownClick() {
  if (dropDownBtns) {
    dropDownBtns.forEach(function (btn) {
      btn.addEventListener('click', function () {
        var accordions = new _accordions.Accordions();
        var links = btn.querySelectorAll('[data-header="header-link-secondary"]');
...
},{"../accordions/accordions":3}],13:[function(require,module,exports){
"use strict";
...
var L = _interopRequireWildcard(require("../../vendor/Leaflet/leaflet.js"));
...
var COORDINATES = [55.0285253, 82.9269913];
var ZOOM_SIZE = 16;
var ICON_URL = 'img/map-pin.svg';
var mobileBreakpoint = window.matchMedia('(max-width:767px)');
var tabletBreakpoint = window.matchMedia('(max-width:1199px)');
var getPinSize = function getPinSize() {
  var pinSize;
...
var setMap = function setMap() {
  ...
  var changeMarker = function changeMarker() {
...
},{"../../vendor/Leaflet/leaflet.js":26}],14:[function(require,module,exports){
"use strict";
...
},{"./modals":16}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initFocus = void 0;
var modal = document.querySelector('[data-modal="about"]');
var input = modal.querySelector('input[data-focus]');
var modalBtn = document.querySelector('[data-open-modal="about"]');
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":25}],17:[function(require,module,exports){
"use strict";
...
var btnContainer = document.querySelector('[data-news="btn-container"]');
var newsBtns = btnContainer.querySelectorAll('[data-name="news-btn"]');
var newsSlides = document.querySelectorAll('[data-news="slide"]');
var newsSlider;
var setNewsSwiper = function setNewsSwiper() {
  newsSlider = new _swiper.default('.news__swiper', {
    keyboard: true,
...
var onBtnContainerClick = function onBtnContainerClick(evt) {
  var currentBtn = evt.target.closest('[data-name="news-btn"]');
  if (!currentBtn.classList.contains('news__button--active')) {
    newsBtns.forEach(function (btn) {
      return btn.classList.remove('news__button--active');
    });
...
var initNewsBtns = function initNewsBtns() {
...
},{"../../vendor/swiper.js":27}],18:[function(require,module,exports){
"use strict";
...
var initSwiper = function initSwiper() {
  var heroSwiper = new _swiper.default('.hero__swiper', {
    pagination: {
      el: '.hero__pagination',
      type: 'bullets',
  ...
  var programsSwiper = new _swiper.default('.programs__swiper', {
    keyboard: true,
    wrapperClass: 'swiper__wrapper',
    slideClass: 'swiper__slide',
    scrollbar: {
  ...
  var feedbackSwiper = new _swiper.default('.feedback__swiper', {
    keyboard: true,
    wrapperClass: 'swiper__wrapper',
    slideClass: 'swiper__slide',
    scrollbar: {
  ...
  var heroSlider = document.querySelector('.hero__slides');
  var heroSlides = heroSlider.querySelectorAll('.hero__slide');
  heroSlides.forEach(function (slide) {
    if (!slide.classList.contains('swiper-slide-duplicate')) {
      slide.setAttribute('tabindex', 0);
    } else {
      var pagination = slide.querySelector('.hero__pagination');
      var button = slide.querySelector('.hero__slide-btn');
...
},{"../../vendor/swiper.js":27}],22:[function(require,module,exports){
"use strict";
